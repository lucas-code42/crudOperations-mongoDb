...
import (
	"github.com/lucas-code42/testMongoDb/pkg/api"
	"github.com/lucas-code42/testMongoDb/pkg/api/router"
)
...
func main() {
	controller := api.InitDependencies()
	router.StartRouters(controller)
}
